...
Usuário autenticado
    ...
    Quando submeto minhas credenciais "cintia@ninjapixel.com" e "pwd123"
...
Senha invalida
    ...
    cintia@ninjapixel.com       abc123      Usuário e/ou senha inválidos
...
Senha não informada
    [Template]          Tentativa de login
    cintia@ninjapixel.com       ${EMPTY}    Opps. Informe a sua senha!
